...
</custom-style>`;template.setAttribute("style","display: none;");document.head.appendChild(template.content)},,function(module,__webpack_exports__,__webpack_require__){"use strict";var _Mathfloor=Math.floor,boot=__webpack_require__(7),mixin=__webpack_require__(6),utils_path=__webpack_require__(5),case_map=__webpack_require__(19),property_accessors=__webpack_require__(49);/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
The complete set of authors may be found at http://polymer.github.io/AUTHORS.txt
...
part of the polymer project is also subject to an additional IP rights grant
found at http://polymer.github.io/PATENTS.txt
*/const PaperInputAddonBehavior={attached:function(){this.fire("addon-attached")},update:function(){}}},function(module,__webpack_exports__,__webpack_require__){"use strict";var _Mathmax=Math.max,_Mathmin=Math.min,_Mathabs2=Math.abs,polymer_legacy=__webpack_require__(2),polymer_dom=__webpack_require__(1);/**
@license
Copyright (c) 2015 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at
http://polymer.github.io/LICENSE.txt The complete set of authors may be found at
...
<div id="checkboxLabel"><slot></slot></div>`;template.setAttribute("strip-whitespace","");Object(_polymer_polymer_lib_legacy_polymer_fn_js__WEBPACK_IMPORTED_MODULE_4__.a)({_template:template,is:"paper-checkbox",behaviors:[_polymer_paper_behaviors_paper_checked_element_behavior_js__WEBPACK_IMPORTED_MODULE_2__.a],hostAttributes:{role:"checkbox","aria-checked":!1,tabindex:0},properties:{ariaActiveAttribute:{type:String,value:"aria-checked"}},attached:function(){Object(_polymer_polymer_lib_utils_render_status_js__WEBPACK_IMPORTED_MODULE_6__.a)(this,function(){var inkSize=this.getComputedStyleValue("--calculated-paper-checkbox-ink-size").trim();if("-1px"===inkSize){var checkboxSizeText=this.getComputedStyleValue("--calculated-paper-checkbox-size").trim(),units="px",unitsMatches=checkboxSizeText.match(/[A-Za-z]+$/);if(null!==unitsMatches){units=unitsMatches[0]}var checkboxSize=parseFloat(checkboxSizeText),defaultInkSize=8/3*checkboxSize;if("px"===units){defaultInkSize=Math.floor(defaultInkSize);if(defaultInkSize%2!==checkboxSize%2){defaultInkSize++}}this.updateStyles({"--paper-checkbox-ink-size":defaultInkSize+units})}})},_computeCheckboxClass:function(checked,invalid){var className="";if(checked){className+="checked "}if(invalid){className+="invalid"}return className},_computeCheckmarkClass:function(checked){return checked?"":"hidden"},_createRipple:function(){this._rippleContainer=this.$.checkboxContainer;return _polymer_paper_behaviors_paper_inky_focus_behavior_js__WEBPACK_IMPORTED_MODULE_3__.b._createRipple.call(this)}})},function(module,__webpack_exports__,__webpack_require__){"use strict";__webpack_require__(131);const PaperSliderClass=customElements.get("paper-slider");class HaPaperSlider extends PaperSliderClass{static get template(){const tpl=document.createElement("template");tpl.innerHTML=PaperSliderClass.template.innerHTML;const styleEl=document.createElement("style");styleEl.innerHTML=`
    ...
    `;tpl.content.appendChild(styleEl);return tpl}}customElements.define("ha-paper-slider",HaPaperSlider)},,,,function(module,__webpack_exports__,__webpack_require__){"use strict";var _polymer_paper_checkbox_paper_checkbox_js__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__(156),_polymer_paper_dropdown_menu_paper_dropdown_menu_js__WEBPACK_IMPORTED_MODULE_1__=__webpack_require__(124),_polymer_paper_icon_button_paper_icon_button_js__WEBPACK_IMPORTED_MODULE_2__=__webpack_require__(62),_polymer_paper_input_paper_input_js__WEBPACK_IMPORTED_MODULE_3__=__webpack_require__(61),_polymer_paper_item_paper_item_js__WEBPACK_IMPORTED_MODULE_4__=__webpack_require__(120),_polymer_paper_listbox_paper_listbox_js__WEBPACK_IMPORTED_MODULE_5__=__webpack_require__(123),_polymer_polymer_lib_utils_html_tag_js__WEBPACK_IMPORTED_MODULE_6__=__webpack_require__(0),_polymer_polymer_polymer_element_js__WEBPACK_IMPORTED_MODULE_7__=__webpack_require__(4),_ha_paper_slider_js__WEBPACK_IMPORTED_MODULE_8__=__webpack_require__(157),_mixins_events_mixin_js__WEBPACK_IMPORTED_MODULE_9__=__webpack_require__(14);class HaForm extends Object(_mixins_events_mixin_js__WEBPACK_IMPORTED_MODULE_9__.a)(_polymer_polymer_polymer_element_js__WEBPACK_IMPORTED_MODULE_7__.a){static get template(){return _polymer_polymer_lib_utils_html_tag_js__WEBPACK_IMPORTED_MODULE_6__.a`
    <style>
      .error {
        color: red;
      }
...
`}static get properties(){return{data:{type:Object,notify:!0},schema:Object,error:Object,computeLabel:{type:Function,value:()=>schema=>schema&&schema.name},computeError:{type:Function,value:()=>error=>error}}}_isArray(val){return Array.isArray(val)}_isRange(schema){return"valueMin"in schema&&"valueMax"in schema}_equals(a,b){return a===b}_includes(a,b){return 0<=a.indexOf(b)}_getValue(obj,item){if(obj){return obj[item.name]}return null}_valueChanged(ev){this.set(["data",ev.model.item.name],ev.detail.value)}_passwordFieldType(unmaskedPassword){return unmaskedPassword?"text":"password"}_passwordFieldIcon(unmaskedPassword){return unmaskedPassword?"hass:eye-off":"hass:eye"}_optionValue(item){return Array.isArray(item)?item[0]:item}_optionLabel(item){return Array.isArray(item)?item[1]:item}}customElements.define("ha-form",HaForm)},,,,,,,,,,,,,,,,,,,,,,,,,,,,function(module,__webpack_exports__,__webpack_require__){"use strict";__webpack_require__.r(__webpack_exports__);var dom_if=__webpack_require__(70),dom_repeat=__webpack_require__(68),ha_iconset_svg=__webpack_require__(102),ha_style=__webpack_require__(121),roboto=__webpack_require__(101),html_tag=__webpack_require__(0),polymer_element=__webpack_require__(4),ha_markdown=__webpack_require__(127),localize_lite_mixin=__webpack_require__(79),paper_button=__webpack_require__(54),ha_form=__webpack_require__(161);class ha_auth_flow_HaAuthFlow extends Object(localize_lite_mixin.a)(polymer_element.a){static get template(){return html_tag.a`
    <style>
      :host {
...
`}static get properties(){return{authProvider:{type:Object,observer:"_providerChanged"},clientId:String,redirectUri:String,oauth2State:String,_state:{type:String,value:"loading"},_stepData:{type:Object,value:()=>({})},_step:{type:Object,notify:!0},_errorMsg:String}}ready(){super.ready();this.addEventListener("keypress",ev=>{if(13===ev.keyCode){this._handleSubmit()}})}async _providerChanged(newProvider,oldProvider){if(oldProvider&&this._step&&"form"===this._step.type){fetch(`/auth/login_flow/${this._step.flow_id}`,{method:"DELETE",credentials:"same-origin"}).catch(()=>{})}try{const response=await fetch("/auth/login_flow",{method:"POST",credentials:"same-origin",body:JSON.stringify({client_id:this.clientId,handler:[newProvider.type,newProvider.id],redirect_uri:this.redirectUri})}),data=await response.json();if(response.ok){this._updateStep(data)}else{this.setProperties({_state:"error",_errorMsg:data.message})}}catch(err){console.error("Error starting auth flow",err);this.setProperties({_state:"error",_errorMsg:this.localize("ui.panel.page-authorize.form.unknown_error")})}}_updateStep(step){const props={_step:step,_state:"step"};if(this._step&&(step.flow_id!==this._step.flow_id||step.step_id!==this._step.step_id)){props._stepData={}}this.setProperties(props)}_equals(a,b){return a===b}_computeSubmitCaption(stepType){return"form"===stepType?"Next":"Start over"}_computeStepAbortedReason(localize,step){return localize(`ui.panel.page-authorize.form.providers.${step.handler[0]}.abort.${step.reason}`)}_computeStepDescription(localize,step){const args=[`ui.panel.page-authorize.form.providers.${step.handler[0]}.step.${step.step_id}.description`],placeholders=step.description_placeholders||{};Object.keys(placeholders).forEach(key=>{args.push(key);args.push(placeholders[key])});return localize(...args)}_computeLabelCallback(localize,step){return schema=>localize(`ui.panel.page-authorize.form.providers.${step.handler[0]}.step.${step.step_id}.data.${schema.name}`)}_computeErrorCallback(localize,step){return error=>localize(`ui.panel.page-authorize.form.providers.${step.handler[0]}.error.${error}`)}async _handleSubmit(){if("form"!==this._step.type){this._providerChanged(this.authProvider,null);return}this._state="loading";this.style.setProperty("min-height",`${this.offsetHeight}px`);const postData=Object.assign({},this._stepData,{client_id:this.clientId});try{const response=await fetch(`/auth/login_flow/${this._step.flow_id}`,{method:"POST",credentials:"same-origin",body:JSON.stringify(postData)}),newStep=await response.json();if("create_entry"===newStep.type){let url=this.redirectUri;if(!url.includes("?")){url+="?"}else if(!url.endsWith("&")){url+="&"}url+=`code=${encodeURIComponent(newStep.result)}`;if(this.oauth2State){url+=`&state=${encodeURIComponent(this.oauth2State)}`}document.location=url;return}this._updateStep(newStep)}catch(err){console.error("Error submitting step",err);this._state="error-loading"}finally{this.style.setProperty("min-height","")}}}customElements.define("ha-auth-flow",ha_auth_flow_HaAuthFlow);class ha_authorize_HaAuthorize extends Object(localize_lite_mixin.a)(polymer_element.a){static get template(){return html_tag.a`
    <style>
      ha-markdown {
        display: block;
        margin-bottom: 16px;
...
`}static get properties(){return{_authProvider:String,_authProviders:Array,clientId:String,redirectUri:String,oauth2State:String,translationFragment:{type:String,value:"page-authorize"}}}async ready(){super.ready();const query={},values=location.search.substr(1).split("&");for(let i=0;i<values.length;i++){const value=values[i].split("=");if(1<value.length){query[decodeURIComponent(value[0])]=decodeURIComponent(value[1])}}const props={};if(query.client_id)props.clientId=query.client_id;if(query.redirect_uri)props.redirectUri=query.redirect_uri;if(query.state)props.oauth2State=query.state;this.setProperties(props);__webpack_require__.e(44).then(__webpack_require__.bind(null,666));try{const response=await window.providersPromise,authProviders=await response.json();if(400===response.status&&"onboarding_required"===authProviders.code){location.href="/";return}if(0===authProviders.length){alert("No auth providers returned. Unable to finish login.");return}this.setProperties({_authProviders:authProviders,_authProvider:authProviders[0]})}catch(err){console.error("Error loading auth providers",err);this._state="error-loading"}}_computeMultiple(array){return array&&1<array.length}async _handleAuthProviderPick(ev){this._authProvider=ev.detail}_computeInactiveProvders(curProvider,providers){return providers.filter(prv=>prv.type!==curProvider.type||prv.id!==curProvider.id)}_computeIntro(localize,clientId,authProvider){return localize("ui.panel.page-authorize.authorizing_client","clientId",clientId)+"\n\n"+localize("ui.panel.page-authorize.logging_in_with","authProviderName",authProvider.name)}}customElements.define("ha-authorize",ha_authorize_HaAuthorize);setTimeout(()=>__webpack_require__.e(70).then(__webpack_require__.t.bind(null,646,7)),2e3)}]);
//# sourceMappingURL=authorize-00e5011a.js.map